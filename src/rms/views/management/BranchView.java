...
public class BranchView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        masterFileLabel.setText("BRANCH");
    ...
    public void setInactive(){
        ...
        for(int i : rows){
            ...
            int colId = ((BaseTableModel)jTable1.getModel()).findColumn(BranchDBTable.STATUS);
            int idColId = ((BaseTableModel)jTable1.getModel()).findColumn(BranchDBTable.ID);
