...
import rms.controllers.management.TableController;
...
public class TableView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Description", "Capacity", "Table Status"
            }
        ) {
    ...
    public void setInactive(){
        ...
        for(int i : rows){
            ...
            int colId = ((BaseTableModel)jTable1.getModel()).findColumn(TableDBTable.STATUS);
            int idColId = ((BaseTableModel)jTable1.getModel()).findColumn(TableDBTable.ID);
    ...
    private void removeInvisibleColumns(){
        for(String inviColumn : TableDBTable.getInstance().getInvisibleColumns()){
    ...
    private boolean canAddRow(){
        ...
        for(String column : TableDBTable.getInstance().getNonNullableColumns()){
    ...
    private void addRow() {
        BaseTableModel model = (BaseTableModel)jTable1.getModel();
        List<String> columnNames = Arrays.asList(TableDBTable.getInstance().getColumns());
        List<Object> values = new ArrayList<Object>(columnNames.size());
        values.add(null);
        values.add(null);
        values.add(null);
        values.add(null);
        values.add(TableDBTable.TABLE_STATUS_VACANT);
